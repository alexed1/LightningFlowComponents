...
export default class QuickChoiceXXX extends LightningElement {
    ...
    connectedCallback() {
        ...
        if (this.legitInputModes.includes(this.inputMode)) {
            ...
            console.log(this.masterLabel + ": ", "QuickChoiceXXX: Need a valid Input Mode value. Didn't get one");
            throw new Error("QuickChoiceXXX: Need a valid Input Mode value. Didn't get one");
        }
    }
