/**
 * Lightning Web Component for Flow Screens:       filterCollection
 * 
...
import filterCollection from '@salesforce/apex/FilterCollectionController.filterCollection';

// * Define the name of the Component
export default class FilterCollection_rsc extends LightningElement {
        ...
        get reactiveValue() { 
            ...
            return JSON.stringify(this.inputCollection) + this.formula;
        }
        ...
        _callAuraEnabledMethod() {
            ...
            .then(result => { 
                ...
                this._fireFlowEvent("errors", returnResults.errors);
